...
<?php
	...
	<?php
		...
		$query="INSERT INTO received_messages (Name,phone,detail)VALUES
		('$Name','$phone','$detail')";
		
		if (mysqli_query($link,$query)===true)
			exit("<p style='color:white;'><b> کاربر گرامی ".$Name.
				"   پیام شما با موفقیت برای کاربر ارسال شد "."</b></p>");
		
		else
			exit("<p style='color:#fff;'><b>پیام شما برای کاربر ارسال نشد!!</b></p>");
